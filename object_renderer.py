...
class GameRenderingEngine:
    ...
    def drawBackground(self):
        self.skyScrollOffset = (self.skyScrollOffset + 4.5 * self.gameInstance.player.rel) % SCREEN_WIDTH
    ...
    def renderGameObjects(self):
        listObjectsToRender = sorted(self.gameInstance.raycasting.objectsToRender, key=lambda t: t[0], reverse=True)
